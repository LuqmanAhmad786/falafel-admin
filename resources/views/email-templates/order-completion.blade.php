...
<div class="container"
    ...
    <div style="padding: 10px 1rem;">
        <h1 style="margin-top: 0; margin-bottom: 0; padding: 15px; font-weight: bold;color: #b90006"> Your Order is Ready
        </h1>
        <hr style="border-bottom: 3px solid #b90006; width: 50px; margin: 0 auto">
        <p class="text-black" class="text-black" style="text-align: left; font-size: 20px; font-weight: 600;">Pickup Time</p>
        ...
        <div class="bg-white" style="background-color: #ffffff; padding: 10px;margin-bottom: 2rem">
        ...
        @if($user_id != 0)
            <div style="width: 100%">
                <a href="{{ url('/') }}/{!! $order_details['order_id'] !!}"
