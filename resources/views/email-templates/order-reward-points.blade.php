...
<div class="container" style="margin: 2rem auto; max-width: 600px; text-align: center; font-family: Montserrat;">
    <div style="width: 100%">
        ...
        <h1 style="margin-top: 0rem;margin-bottom: 0;padding: 15px;font-weight: bold;color:#b90006;">Free Entree to Enjoy!</h1>
        <hr style="border-bottom: 3px solid #b90006;width: 50px;margin: 0 auto;">
    </div>
    <div style="background-color: #ffffff;padding: 2rem;margin-top: 1rem;padding-top: 0px;">
        <p style="margin-top: 0px; margin-bottom: 0px">Congratulations {!! $name !!}!<br/>
            You've hit 2,000 reward points! Your free entree is waiting. Order now!
        </p>
    </div>
    <div style="clear: both;background-color: #f5f5f5; padding: 20px;">
        <h2 style="margin: 0;font-weight: 600;margin-bottom: 1.5rem;">Get your free entry now!</h2>
        <div style="width: 100%;">
        ...
        <div style="width: 100%;clear: both;">
            <a href="https://farmersfreshkitchen.com/menu"
