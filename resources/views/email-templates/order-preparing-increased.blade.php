...
<div class="container" style="margin: 2rem auto; max-width: 600px; text-align: center; font-family: Montserrat;">
    ...
    <div style="background-color: #f5f5f5;padding: 2rem;">
        <h1 style="margin-top: 0; margin-bottom: 0; padding: 15px; font-weight: bold;color:#b90006;">Delay in Preparing Order</h1>
        <hr style="border-bottom: 3px solid #b90006; width: 50px; margin: 0 auto">
        <p class="text-black" style="margin-top: 30px; margin-bottom: 30px">Hi {!! $name !!}, We are running a little behind on your order. We apologize for the inconvenience. Rest assured, we're working hard to get it to you as soon as possible.
        </p>
        <h3 class="text-black" style="margin: 0;font-weight: 600;margin-bottom: 1.5rem;text-align: left;">New Pickup Time</h3>
        <div style="background-color: #ffffff;padding: 2rem;">
            <h1 style="margin-top: 0; margin-bottom: 0; padding: 15px; font-weight: bold;color:#b90006;">{!! $preparation_time !!}</h1>
