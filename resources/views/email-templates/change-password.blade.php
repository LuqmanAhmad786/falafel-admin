...
<div class="container" style="margin: 2rem auto; max-width: 600px; text-align: center; font-family: Montserrat;">
    ...
    <div style="background-color: #ffffff;padding: 0 2rem;padding-bottom: 2rem;">
        <h1 style="margin-top: 0; margin-bottom: 0; padding: 15px; font-weight: bold;color:#b90006;">Password Updated Successfully!</h1>
        <hr style="border-bottom: 3px solid #b90006; width: 50px; margin: 0 auto">
        <p style="margin-top: 30px; margin-bottom: 30px">Hi {!! $name !!}, your password
            has been successfully updated.
        </p>
    </div>
    <div style="clear: both;background-color: #f2f2f2; padding: 20px;">
        <h2 style="margin: 0;font-weight: 600;margin-bottom: 1.5rem;">Order Now & Earn Rewards!</h2>
        <div style="width: 100%;">
