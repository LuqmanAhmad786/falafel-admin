...
<div class="container"
    ...
    <div style="background-color: #ffffff; min-height: 43rem;">
        <h1 style="margin: 0;padding: 15px;font-weight: 600;color: #b90006;padding-bottom: 0;">Account Deleted</h1>
        <hr style="border: 2px solid #b90006; width: 50px; margin-bottom: 0 auto">
        <p class="text-black" style="font-weight: normal">Your account has been deleted. We would miss you!</p>
        <p class="text-black">You can still create account again if don't want to miss out on Special bonuses and rewards offers.</p>
        <div style="background-color: #f5f5f5;margin-top: 2rem; padding: 20px; margin-bottom: 0rem;">
            <div style="width: 100%;clear: both;background: #fff;">
                <img  alt="" style="width: 50%;margin-top: 1rem;"
                      src="https://fcadmin77.falafelcorner.us/public/images/ffr.jpg">
                <div style="width: 100%; display: inline-flex; margin-top: 1rem">
                    ...
                    <div style="width: 70%; display:block; text-align: left;">
                        <p class="text-black" style="color: #b90006;font-weight: bold;">Order and earn 10 points for each $1 spent.</p>
                    </div>
                </div>
                ...
                <div style="width: 100%; display: inline-flex; margin-top: 1rem;">
                    <div style="width: 25%; display:block">
                        <img style="width: 70%"
                             src="https://fcadmin77.falafelcorner.us/public/images/award(2).png">
                    </div>
                    <div style="width: 70%; display:block; text-align: left">
                ...
                <div style="width: 100%; display: inline-flex; margin-top: 1rem;">
                    <a href="https://fcadmin77.falafelcorner.us/signup"
