...
<div class="container" style="margin: 2rem auto; max-width: 600px; text-align: center; font-family: Montserrat;">
    ...
    <div style="background-color: #ffffff;padding: 0 2rem;">
        <h1 style="margin-top: 0; margin-bottom: 0; padding: 15px; font-weight: bold;color:#b90006;">Password Updated Reset!</h1>
        <hr style="border-bottom: 3px solid #b90006; width: 50px; margin: 0 auto">
        <p class="text-black" style="margin-top: 30px; margin-bottom: 30px">Hi {!! $name !!}, your password
            has been successfully reset.
        </p>
    </div>
    <div style="clear: both;background-color: #f5f5f5; padding: 20px; margin-bottom: 0rem;">
        <h2 class="text-black" style="margin: 0;font-weight: 600;margin-bottom: 1.5rem;">Order Now & Earn Rewards!</h2>
        <div style="width: 100%;">
