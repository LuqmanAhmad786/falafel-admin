...
<div class="container" style="margin: 2rem auto; max-width: 600px; text-align: center; font-family: Montserrat;">
    <div style="width: 100%">
        ...
        <h1 style="margin-top: 0rem;margin-bottom: 0;padding: 15px;font-weight: bold;color:#b90006;">Exclusive Offer For You</h1>
    ...
    <div style="background-color: #ffffff;padding: 2rem;margin-top: 1rem;padding-top: 0">
        <p class="text-black" style="margin-top: 0px; margin-bottom: 0px">Congratulations {!! $name !!}!<br/>
            You've been rewarded with a New Offer!
        </p>
    </div>
    <div style="clear: both;background-color: #f5f5f5; padding: 20px;">
        <h2 class="text-black" style="margin: 0;font-weight: 600;margin-bottom: 1.5rem;">Lucky you!</h2>
        <div style="width: 100%;">
