...
<div class="container"
    ...
    <div style="background-color: #f2f2f2;padding: 0 2rem;padding-bottom: 2rem;">
        <h1 style="margin-top: 0; margin-bottom: 0; padding: 15px; font-weight: bold;color:#b90006;">Reset Your Password
        </h1>
        <hr style="border-bottom: 3px solid #b90006; width: 50px; margin: 0 auto">
        <p class="text-black"  style="margin-top: 30px; margin-bottom: 30px;">Hi , please click below to reset your password.
        </p>
        <p><a style="padding: 8px 30px;color: #b90006;border: 2px solid #b90006;font-size: 18px;font-weight: 600;margin: 1rem auto 2rem;text-decoration: none;" href="{{url('/reset-password/'.$token)}}">Reset your password</a>
        </p>
        <p class="text-black"  style="margin-top: 30px; margin-bottom: 30px;">The reset password link will be valid upto {{date('M d, Y, H:i A',$valid_till)}}
        </p>
        <br/>
        <p class="text-black"  style="margin: 0;">If you did not request a password reset, please ignore this email.</p>
    </div>
    <div class="footer"
