...
<div class="container" style="margin: 2rem auto; max-width: 600px; text-align: center; font-family: Montserrat;">
    ...
    <div style="background-color: #f2f2f2;padding: 0 2rem;padding-bottom: 2rem;">
        ...
        <p style="margin-top: 30px; margin-bottom: 30px">Hi {!! $name !!}, we spotted a change to your account details.</p>
        <p style="margin-top: 30px; margin-bottom: 30px">If this wasn't you, please contact our support team by replying to this email or clicking the button below.
        </p>
        <p><a style="padding: 8px 30px;color: #b90006;border: 2px solid #b90006;font-size: 18px;font-weight: 600;margin: 1rem auto 2rem;text-decoration: none;" href="{{ url('/') }}/contact-us">Contact Now</a>
    </div>
    <div class="footer"
