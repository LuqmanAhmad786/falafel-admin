...
<div class="container"
    ...
    <div style="background-color: #f2f2f2;padding: 0 2rem;padding-bottom: 2rem;">
        <h1 style="margin-top: 0; margin-bottom: 0; padding: 15px; font-weight: bold;color:#b90006;">Requested Password Reset
        </h1>
        <hr style="border-bottom: 3px solid #b90006; width: 50px; margin: 0 auto">
        <p class="text-black"  style="margin-top: 30px; margin-bottom: 30px;">Hi {!! $name !!}, Please click the button below to reset your account's password at Falafel's
        </p>
        <p><a style="padding: 8px 30px;color: #b90006;border: 2px solid #b90006;font-size: 18px;font-weight: 600;margin: 1rem auto 2rem;text-decoration: none;" href="{!! $link !!}">Reset your password</a>
        </p>
        <br/>
        <p class="text-black"  style="margin: 0;">If this request wasn't made by you, Please ignore this email.</p>
    </div>
    <div class="footer"
